...
public class POSTag {
	...
	public static final int NOUN_ZHUAN_TOOL = str2int("nzy");// nzy	仪器工具专名	取汉语拼音yiqi的首字母
	public static final int NOUN_ZHUAN_CHEMICAL = str2int("nzz");// nzz	化工专名	
	...
	public static final HashSet<Integer> NON_SENSE_TAG = new HashSet<Integer>();

	private static final HashMap<Integer,Double> weightMap=initWeightMap();
		
	static {
		NON_SENSE_TAG.add(SEN_BEGIN);
		NON_SENSE_TAG.add(SEN_END);
		NON_SENSE_TAG.add(CONJ);
		NON_SENSE_TAG.add(EXC);
		NON_SENSE_TAG.add(NUM);
		NON_SENSE_TAG.add(ONOM);
		NON_SENSE_TAG.add(PREP);
		NON_SENSE_TAG.add(QUAN);
		NON_SENSE_TAG.add(TIME);
		NON_SENSE_TAG.add(AUXI);
		NON_SENSE_TAG.add(PUNC);
		NON_SENSE_TAG.add(YUQI);
		NON_SENSE_TAG.add(str2int("uj"));
		NON_SENSE_TAG.add(str2int("ul"));
		NON_SENSE_TAG.add(str2int("ug"));
	}
