...
/**
 * <p>A hash map that uses two primitive ints for the key rather than objects.</p>
 *
...
public class IntIntHashMap<E> {
    ...
    private static class Entry<E> {
         ...
         */
        protected Entry(int first, int second, E value, Entry<E> next) {
            this.first = first;
            this.second = second;
            this.value = value;
            this.next = next;
     ...
     * @see     #put(int, Object)
     */
    public E get(int first, int second) {
        Entry<E> tab[] = table;
        int hash = (int)(first ^ (second >>> 1));
    ...
    protected void rehash() {
        ...
        for (int i = oldCapacity; i-- > 0;) {
            for (Entry<E> old = oldMap[i]; old != null;) {
                ...
                int hash = (int)(e.first ^ (e.second >>> 1));
     ...
     * @see     #get(int)
     */
    public E put(int first, int second, E value) {
        ...
        Entry<E> e = new Entry<E>(first, second, value, tab[index]);
        tab[index] = e;
        count++;
        return null;
    }
