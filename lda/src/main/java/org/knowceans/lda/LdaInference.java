...
public class LdaInference {
    public static float VAR_CONVERGED = 1e-5f;
    public static int VAR_MAX_ITER = 2;

    /*
     * variational inference
     */
    public static double ldaInference(Document doc, LdaModel model, double[] varGamma, double[][] phi) {
        double converged = 1;
